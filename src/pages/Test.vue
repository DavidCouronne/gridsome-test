...
Solid background with centered links and off-canvas menu
Preview
Code
...
Simple with avatar header
Preview
Code
<div id="dropdown" class="relative inline-block">
  <button @click="isOpen = true" :class="isOpen ? 'bg-gray-900' : 'bg-gray-800'" class="inline-flex items-center pl-6 pr-2 py-2 font-semibold text-white rounded-lg hover:bg-gray-700 focus:outline-none focus:shadow-outline active:bg-gray-900">
    Account
